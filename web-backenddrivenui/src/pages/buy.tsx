...
const Buy = ({serviceSelected}:{serviceSelected:Service}) => {
 ...
 return(
    ...
    {serviceSelected?.service ?? '' ? <Heading size={"md"} color='blue'>Thanks for your purchase!</Heading> : <Heading size={"md"} color='tomato'>You have to select a service to buy!</Heading>}
    ...
    <Button id={'btn1ok'} onClick={e=>handleclick(e)} colorScheme='blue' alignSelf={"center"}>Finish</Button> 
    </VStack>
 );
}
